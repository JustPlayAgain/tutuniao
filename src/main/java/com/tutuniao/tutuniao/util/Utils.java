...
public final class Utils {
    ...
    private static final DateFormat dfSSS_nosplit = new SimpleDateFormat("yyyyMMddHHmmssSSS"); // 有毫秒
    ...
    public static String convertSecondTimeToString(Integer secondTime) {
        ...
        String timeStr = "";
        // 小时
        Integer hour = secondTime / 3600;
        // 分钟
        Integer minute = secondTime % 3600 / 60;
        // 秒
        Integer second = secondTime % 60;
    ...
    public static boolean isValidDate(String date) {
        ...
        try {
            ...
            if (month == 2 && day == 29 && !isGregorianLeapYearOverload(year)) {
                return false;
            }
     ...
     * 判断是否闰年
     */
    public static final boolean isGregorianLeapYearOverload(int year) {
    ...
    public static boolean isGreaterThan30(String timeStamp, int day) {
        ...
        // 系统当前时间，单位秒
        long nowDate = now.getTime() / 1000;
        // 要做比较的时间,单位秒
        long srcDate = date.getTime() / 1000;
        // 30天的秒数
        long date30 = day * 24 * 3600;
    ...
    public static String convertPannyToString(Integer panney) {
        ...
        String moneyStr = "";
        // 元
        Integer yuan = panney / 100;
        // 角
        Integer jiao = panney % 100 / 10;
        // 分
        Integer fen = panney % 100 % 10;
    ...
    public static String doubleToStr(Object o) {
        if (o == null) {
            return "0";
        }
        try {
